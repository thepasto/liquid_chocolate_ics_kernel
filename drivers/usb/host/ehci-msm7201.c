...
static const struct hc_driver ehci_msm7201_hc_driver = {
	...
	.product_desc = "Qualcomm MSM7201/QSD8X50/MSM7227 On-Chip EHCI Host Controller",
...
static int usb_hcd_msm7201_probe(struct platform_device *pdev)
{
	...
	pr_debug("usb_hcd_msm7201_probe()\n");

	if (usb_disabled())
		return -ENODEV;

	pr_debug("initializing MSM7201/QSD8X50/MSM7227 USB Controller\n");
